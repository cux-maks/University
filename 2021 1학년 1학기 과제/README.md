...
|입력 예시|출력 예시|
|:-:|:-:|
|첫 번째 수 입력: 3<pre>두 번째 수 입력: 5|3은(는) 5보다 작습니다.|
|첫 번째 수 입력: 7<pre>두 번째 수 입력: 7|두 수는 같습니다.|
|첫 번째 수 입력: 5<pre>두 번째 수 입력: 3|5은(는) 3보다 큽니다.|
...
|입력 예시|출력 예시|
|:-:|:-:|
|키 : 150<pre>나이 : 9|죄송합니다.|
|키: 180<pre>나이 : 21|타도 좋습니다.|
